...
@ApplicationScoped
@ApplicationPath("/")
public class App01UsersApplication extends Application {
	...
	public Set<Class<?>> getClasses() {
		return Set.of(ServicioUsersRest.class, PingRest.class);
	}
	...
	public void init(@Observes @Initialized(ApplicationScoped.class) Object init) {
		...
		check.setMethod("GET");
		check.setHttp("http://127.0.0.1:" + puerto + "/pingUsers");
